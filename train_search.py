...
'''
    args.mode: (weight indicates the convolutional parameter, while alpha encodes the network architecture)
            0, joint update weight, alpha and beta
            1, update weight, alpha and beta by coordinate descent
            2, update weight, alpha and beta by coordinate descent, except that we use old weight to update alpha
            3, use hessian gradient to update weight, alpha and beta
'''
...
def main():
    ...
    parser.add_argument('--out_stride', type=int, default=8, help='network output stride (default: 8)')
